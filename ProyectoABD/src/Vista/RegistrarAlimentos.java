...
public class RegistrarAlimentos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cantidad en toneladas:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(TexNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(TexNombre.getText().isEmpty()|TextCantidad.getText().isEmpty()|"Sede".equals(ComboSede.getSelectedItem())){
           JOptionPane.showMessageDialog(null, "Favor de llenar todos los campos");
        }else{
            String ciudad = (String) ComboSede.getSelectedItem();
            int idsede = ca.passCiudadID(ciudad);
            int cantidad = Integer.parseInt(TextCantidad.getText());
            ca.resgistrarAlimento(TexNombre.getText().toUpperCase(), cantidad, idsede);
        }
